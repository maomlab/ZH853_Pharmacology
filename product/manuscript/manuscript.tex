...
\begin{figure}[htbp]
  ...
  oriented \uOR{} (grey cartoon) with the 84 cholesterols modeled in the density (orange, ball-and-stick)
  and ZH853 (green). The cholesterols mark the lipid bilayer band directly: the transmembrane helices
  span it, the intracellular loops hang below, and ZH853 sits at the extracellular boundary; the
  midplane and thickness this defines are quantified in (B). \textbf{(B)} Determination: distribution
