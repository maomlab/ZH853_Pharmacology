...
reference SMILES, confirming the monomeric macrocycle.
...
Val3.28/Ile3.29, Ile6.51, Val6.55, Val5.42). Every one of these contacts is shared by all twelve
comparator agonists (Figure~\ref{fig:heatmap}), confirming that ZH853 presents the same ``message''
...
All four analogs sit firmly beyond rule-of-5 (MW 714--810, TPSA 235--280\,\Angsq, 8--10 H-bond donors;
Figure~\ref{fig:props}); the dominant liabilities are high polar surface area and donor count. Their 3D
