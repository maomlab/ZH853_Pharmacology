...
C$\alpha$ cloud) is rotated onto $z$; the \textbf{84 cholesterols modeled in the density} at the lipid-facing
surface then set the bilayer geometry --- their mean $z$ defines the hydrophobic midplane ($z=0$) and
...
\begin{figure}[htbp]
  ...
  oriented \uOR{} (grey cartoon) with the 84 modeled cholesterols (orange, ball-and-stick) and ZH853
