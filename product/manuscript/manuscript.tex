...
\begin{figure}[htbp]
  ...
  \caption{The experimentally characterized MOR--ZH853--Gi--scFv16 cryo-EM complex (Mol* render):
  \uOR{} receptor 7TM bundle (gold), G$\alpha$i (orange), G$\beta$ (teal), G$\gamma$ (purple), and
  scFv16 (magenta), with ZH853 (green sticks) in the orthosteric pocket.}
  \label{fig:overview}
\end{figure}
