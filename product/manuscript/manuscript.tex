...
MOR + ZH853 alone with the intracellular half of the receptor Cα-restrained (or the G$\alpha$ C-terminal
...
\textbf{3.7 Membrane, force field, and equilibration.} The receptor is pre-oriented to the bilayer
normal with OPM/PPM [19] (consistent with the 84 modeled cholesterols) and embedded
in a POPC:cholesterol (9:1) membrane using CHARMM-GUI Membrane Builder [20] --- a
