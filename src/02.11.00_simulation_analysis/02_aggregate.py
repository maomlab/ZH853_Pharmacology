...
Run: ``python src/02.11.00_simulation_analysis/02_aggregate.py``  (or ``make sim-aggregate``).
"""
...
def main() -> int:
    ...
    if not results:
        raise SystemExit(
            ...
            "  intermediate/02.11.00_analysis/ back (see this stage's README).")
    ...
    lines = [
        ...
        "",
        f"Generated by `src/02.11.00_simulation_analysis/02_aggregate.py` from "
